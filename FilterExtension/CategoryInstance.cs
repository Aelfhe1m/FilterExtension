...
namespace FilterExtensions
{
    public class CategoryInstance
    {
        ...
        {
            Name = Localizer.Format(protoC.CategoryName.Trim());
        ...
        {            
            if (Type == CategoryNode.CategoryType.NEW)
            {
                ...
                PartCategorizer.Category category = PartCategorizer.AddCustomFilter(Name, Localizer.Format(Name.Trim()), icon, Colour);
            ...
            {
                if (!PartCategorizer.Instance.filters.TryGetValue(c => string.Equals(Localizer.Format(c.button.categoryName.Trim()), Name.Trim(), StringComparison.OrdinalIgnoreCase),
